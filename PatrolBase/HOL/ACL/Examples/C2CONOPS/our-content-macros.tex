...
\newcommand{\readernote}[2]{\shadowbox{\parbox{\textwidth}{%
...
\newcommand{\slv}[1]{\ensuremath{\text{\textsf{ sl}}(#1)}}
\newcommand{\ilv}[1]{\ensuremath{\text{\textsf{ il}}(#1)}}
...
\newenvironment{formalProof}{\begin{center}\small\begin{tabular}{ll}}{\end{tabular}\end{center}} 
