...
struct
  val _ = if !Globals.print_thy_loads then print "Loading ssmMoveToPBTheory ... " else ()
  open Type Term Thm
  infixr -->
  ...
  val _ = Theory.link_parents
          ("ssmMoveToPB",
          Arbnum.fromString "1500249966",
          Arbnum.fromString "89644")
          [("MoveToPBType",
  ...
  [ID("min", "fun"), ID("aclfoundation", "Form"),
   ...
   ID("aclfoundation", "Name"), ID("MoveToPBType", "PLAN_PB"),
   ID("MoveToPBType", "PLTForm"), ID("MoveToPBType", "PLTHalt"),
   ID("MoveToPBType", "PLTMove"), ID("MoveToPBType", "PLTPlan"),
   ID("MoveToPBType", "PLT_FORM"), ID("MoveToPBType", "PLT_HALT"),
   ID("MoveToPBType", "PLT_MOVE"), ID("MoveToPBType", "PlatoonLeader"),
   ID("aclfoundation", "Princ_CASE"), ID("OMNIType", "SLc"),
   ID("ssm11", "SOME"), ID("bool", "T"), ID("ssm11", "TR"),
  ...
  fun op moveToPBNS_ind x = x
    ...
    ThmBind.DT(((("ssmMoveToPB",2),
                [("MoveToPBType",[22,48]),("OMNIType",[36]),
                 ("bool",[25,26,46,47,52,53,57,62,71,75,76,77,79]),
                 ("pair",[5,16]),("relation",[101,107]),
                 ("sat",[1,3,5,6,7,11,12,13,14,15]),
                 ("ssm11",[31])]),["DISK_THM"]),
               [ThmBind.read"%176%6%196%189$0%211@%239%221%249@4%189$0%211@%239%221%241@4%189$0%216@%239%221%251@4%189$0%216@%239%221%241@4%189$0%218@%239%221%250@4%189$0%218@%239%221%241@4%189$0%217@%239%221%230@4%189$0%217@%239%221%241@4%189%184%15%183%12$2$1@%260%221$0@3|@|@2%189%184%15%183%12$2$1@%232%221$0@3|@|@2%189%184%15%174%124$2$1@%232%204$0@3|@|@2%189%184%15%174%158$2$1@%260%204$0@3|@|@2%189%174%46$1%211@%239%204$0@3|@2%189$0%211@%239%221%251@4%189$0%211@%239%221%250@4%189$0%211@%239%221%230@4%189%174%71$1%216@%239%204$0@3|@2%189$0%216@%239%221%249@4%189$0%216@%239%221%250@4%189$0%216@%239%221%230@4%189%174%75$1%218@%239%204$0@3|@2%189$0%218@%239%221%249@4%189$0%218@%239%221%251@4%189$0%218@%239%221%230@4%189%174%80$1%217@%239%204$0@3|@2%189$0%217@%239%221%249@4%189$0%217@%239%221%251@4%189$0%217@%239%221%250@4%173%83$1%200@%239$0@2|@30%184%21%186%23$2$1@$0@|@|@2|@"])
  fun op moveToPBNS_def x = x
    val op moveToPBNS_def =
    ThmBind.DT(((("ssmMoveToPB",3),
                [("MoveToPBType",[18,44]),("OMNIType",[30]),
                 ("bool",[15,57]),("combin",[19]),("pair",[49]),
                 ("relation",[107,126]),("ssm11",[25]),
                 ("ssmMoveToPB",[0,1])]),["DISK_THM"]),
               [ThmBind.read"%189%195%245%211@%239%221%249@4%216@2%189%195%245%211@%239%221%241@4%211@2%189%195%245%216@%239%221%251@4%218@2%189%195%245%216@%239%221%241@4%216@2%189%195%245%218@%239%221%250@4%217@2%189%195%245%218@%239%221%241@4%218@2%189%195%245%217@%239%221%230@4%200@2%189%195%245%217@%239%221%241@4%217@2%189%195%245%15@%260%221%12@4%15@2%195%245%15@%232%221%12@4%15@10"])
  ...
  fun op moveToPBOut_def x = x
    ...
    ThmBind.DT(((("ssmMoveToPB",7),
               ...
               [ThmBind.read"%189%194%246%211@%239%221%249@4%212@2%189%194%246%211@%239%221%241@4%215@2%189%194%246%216@%239%221%251@4%214@2%189%194%246%216@%239%221%241@4%212@2%189%194%246%218@%239%221%250@4%213@2%189%194%246%218@%239%221%241@4%214@2%189%194%246%217@%239%221%230@4%203@2%189%194%246%217@%239%221%241@4%213@2%189%194%246%15@%260%221%12@4%262@2%194%246%15@%232%221%12@4%261@10"])
  ...
  val _ = Theory.LoadableThyData.temp_encoded_update {
    ...
    read = ThmBind.read,
    data =
        "OO10.moveToPBNS4.%245OO11.moveToPBOut4.%246OO16.authTestMoveToPB4.%229OO22.ssmMoveToPBStateInterp4.%259OO18.secContextMoveToPB4.%257"
  }
