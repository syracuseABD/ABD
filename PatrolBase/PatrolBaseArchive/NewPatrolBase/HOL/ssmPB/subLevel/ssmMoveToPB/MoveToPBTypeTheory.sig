...
(*
   ...
   [datatype_slOutput]  Theorem
      ...
      |- DATATYPE
           (slOutput PLTPlan PLTForm PLTMove PLTHalt Complete unAuthorized
              unAuthenticated)

   [datatype_slState]  Theorem

      |- DATATYPE (slState PLAN_PB PLT_FORM PLT_MOVE PLT_HALT COMPLETE)
   ...
   [slOutput_distinct]  Theorem
      ...
      |- PLTPlan ≠ PLTForm ∧ PLTPlan ≠ PLTMove ∧ PLTPlan ≠ PLTHalt ∧
   ...
   [slOutput_induction]  Theorem
      ...
      |- ∀P.
           P Complete ∧ P PLTForm ∧ P PLTHalt ∧ P PLTMove ∧ P PLTPlan ∧
   ...
   [slOutput_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = PLTPlan) ∨ (a = PLTForm) ∨ (a = PLTMove) ∨ (a = PLTHalt) ∨
   ...
   [slState_distinct]  Theorem
      ...
      |- PLAN_PB ≠ PLT_FORM ∧ PLAN_PB ≠ PLT_MOVE ∧ PLAN_PB ≠ PLT_HALT ∧
         PLAN_PB ≠ COMPLETE ∧ PLT_FORM ≠ PLT_MOVE ∧ PLT_FORM ≠ PLT_HALT ∧
         PLT_FORM ≠ COMPLETE ∧ PLT_MOVE ≠ PLT_HALT ∧ PLT_MOVE ≠ COMPLETE ∧
         PLT_HALT ≠ COMPLETE
   ...
   [slState_induction]  Theorem
      ...
      |- ∀P.
           P COMPLETE ∧ P PLAN_PB ∧ P PLT_FORM ∧ P PLT_HALT ∧ P PLT_MOVE ⇒
           ∀a. P a
