...
(* occurs if and only if prop (SOME cmd), inputTest, and                       *)
(* CFGInterpret (M,Oi,Os)                                                     *)
(*  (CFG inputTest stateInterpret certList (P says prop (SOME cmd)::ins) s outs)*)
(* are true.                                                                  *)
(* -------------------------------------------------------------------------- *)
...
(* CFGInterpret (M,Oi,Os)                                                     *)
(*  (CFG inputTest stateInterpret certList (P says prop (SOME cmd)::ins)      *)
(*       s outs) are true.                                                    *)
(* -------------------------------------------------------------------------- *)
